                ...
                <div id="tasks" className="my-5">
                    {
                        todos.length > 1 ? todos.map((item) => (
                            <div key={item.id} id="task" className="flex justify-between items-center border-b border-slate-200 py-3 px-2 border-l-4  border-l-transparent bg-gradient-to-r from-transparent to-transparent hover:from-slate-100 transition ease-linear duration-150">
                                ...
                                <div onClick={() => removeTodoItem(item.id)}>
